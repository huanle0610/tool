...
function showMenu(v) {
	...
	var maxh = isUndefined(v['maxh']) ? 700 : v['maxh'];
...
function showWindow(k, url, mode, cache, menuv) {
	...
	if(!menuObj) {
		...
		menuObj.style.display = 'none';
		$('append_parent').appendChild(menuObj);
		menuObj.innerHTML = '<table cellpadding="0" cellspacing="0" class="fwin"><tr><td class="t_l"></td><td class="t_c" style="cursor:move" onmousedown="dragMenu($(\'fwin_' + k + '\'), event, 1)" ondblclick="hideWindow(\'' + k + '\')"></td><td class="t_r"></td></tr><tr><td class="m_l" ondblclick="hideWindow(\'' + k + '\')" style="cursor:move" onmousedown="dragMenu($(\'fwin_' + k + '\'), event, 1)" >&nbsp;&nbsp;</td><td class="m_c" id="fwin_content_' + k + '">'
			+ '</td><td class="m_r" style="cursor:move" onmousedown="dragMenu($(\'fwin_' + k + '\'), event, 1)" ondblclick="hideWindow(\'' + k + '\')"></td></tr><tr><td class="b_l"></td><td class="b_c" style="cursor:move" onmousedown="dragMenu($(\'fwin_' + k + '\'), event, 1)" ondblclick="hideWindow(\'' + k + '\')"></td><td class="b_r"></td></tr></table>';
		if (mode == 'html') {
	...
	for(var i = 0; i < selectObj.options.length; i++) {
		...
		li.onclick = function() {
			if($(selectId + '_ctrl').innerHTML != this.innerHTML) {
				...
				eval(selectObj.getAttribute('onchange'));
...
function strLenCalc(obj, checklen, maxlen,allowfull) {
	allowfull=allowfull==undefined?false:true;
